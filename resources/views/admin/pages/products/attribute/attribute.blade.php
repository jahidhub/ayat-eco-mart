                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Manage Attribute</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                    <button type="button" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                        data-bs-target="#attribute_model" onclick="saveData('0', '', '', 'Add Attribute' )">Add New
                        Attribute</button>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-inline-flex gap-2">
                                                            <!-- Edit Button -->
                                                            <button
                                                                onclick="saveData('{{ $attribute->id }}','{{ $attribute->name }}','{{ $attribute->slug }}', 'Edit Product Attribute')"
                                                                class="btn btn-sm btn-outline-dark" title="Edit"
                                                                data-bs-toggle="modal" data-bs-target="#attribute_model">
                                                                <i class="lni lni-pencil-alt"></i>
                                                            </button>

                                                            <!-- Delete Button -->
                                                            <button
                                                                onclick="deleteData('{{ $attribute->id }}' , 'attributes' )"
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="example_info" role="status" aria-live="polite">
                                        Showing {{ $attributes->firstItem() }} to {{ $attributes->lastItem() }} of
                                        {{ $attributes->total() }} entries
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="attribute_model" tabindex="-1" aria-labelledby="modal-title" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form id="form_submit" action="{{ route('admin.attribute.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="slug" class="form-label fw-semibold">Attribute Slug</label>
                                    <input type="text" id="slug" name="slug"
                                        class="form-control form-control-lg" placeholder="e.g. brand"
                                        aria-label="Attribute Slug">
                                    <div class="invalid-feedback">
                                        Please enter a attribute slug.
                                    </div>
                                </div>
...
@section('customJs')
    <script>
        function saveData(id, attribute_name, slug, title) {
            $('#id').val(id);
