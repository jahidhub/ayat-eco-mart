    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Values</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Manage Attribute Value</li>
                        </ol>
                    </nav>
                </div>
                <div class="ms-auto">
                    <button type="button" class="btn btn-sm btn-dark" data-bs-toggle="modal"
                        data-bs-target="#attribute_value_model" onclick="saveData('0', '', '', 'Add Attribute Value' )">Add
                        New
                        Value</button>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-inline-flex gap-2">
                                                            <!-- Edit Button -->
                                                            <button
                                                                onclick="saveData('{{ $data->id }}','{{ $data->attribute_id }}','{{ $data->attribute_value }}', 'Edit Product attribute_value')"
                                                                class="btn btn-sm btn-outline-dark" title="Edit"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#attribute_value_model">
                                                                <i class="lni lni-pencil-alt"></i>
                                                            </button>

                                                            <!-- Delete Button -->
                                                            <button
                                                                onclick="deleteData('{{ $data->id }}' , 'attribute_values' )"
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="example_info" role="status" aria-live="polite">
                                        Showing {{ $attribute_values->firstItem() }} to {{ $attribute_values->lastItem() }}
                                        of
                                        {{ $attribute_values->total() }} entries
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="attribute_value_model" tabindex="-1" aria-labelledby="modal-title"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form id="form_submit" action="{{ route('admin.attribute_value.store') }}"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="value" name="value"
                                        class="form-control form-control-lg" placeholder="e.g. 4gb ram"
                                        aria-label="attribute_value Slug">
                                    <div class="invalid-feedback">
